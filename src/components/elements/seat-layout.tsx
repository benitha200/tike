...
// interface Props {
//   columns: number;
//   seats_per_column: number;
//   seats_per_row: number;
//   handleSelectSeat: SelectSeatEventHandler;
// }

// export default function SeatLayout(props: Props) {
//   const { columns, seats_per_column, seats_per_row, handleSelectSeat } = props;
//   const [booked, setBooked] = useState(0);
//   const seatNo = ["A", "B", "C", "D", "E", "F", "G", "H", "I"];
//   useEffect(() => {
//     setBooked(Math.floor(Math.random() * 11));
//   }, []);

//   return (
//     <div
//       className={`w-40 grid grid-cols-${columns} gap-x-4 border-2 border-gray-400 rounded-xl pt-14 pb-2 px-2`}
//     >
//       {[...Array(columns)].map((column, i) => (
//         <div className={`grid grid-cols-2 gap-y-2`} key={i}>
//           {[...Array(seats_per_column)].map((seat, j) =>
//             booked % j == 0 ? (
//               <Image
//                 key={j}
//                 src={"/seats/unavailable.svg"}
//                 width={100}
//                 height={100}
//                 alt=""
//               />
...
//                   <p className="text-sm">
//                     <Button
//                       onClick={() => handleSelectSeat(`${i + 1}_${j + 1}`)}
//                     >
//                       Book Seat: {`${seatNo[i]}${j + 1}`}
//                     </Button>
//                   </p>
//                 </PopoverContent>
//               </Popover>
